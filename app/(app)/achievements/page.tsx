                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    {isUnlocked && !isClaimed && (
                                        <button
                                            ...
                                            className={`mt-3 inline-flex items-center justify-center px-4 py-2 rounded-lg text-white text-sm font-extrabold tracking-tight ring-1 ring-white/10 transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-kick-green/60 ${
                                                claimingId === achievement.id
                                                    ? 'bg-kick-green/70 cursor-wait'
                                                    : claimingId !== null
                                                    ? 'bg-kick-green/50 cursor-not-allowed'
                                                    : 'bg-kick-green shadow-[0_10px_30px_rgba(34,197,94,0.25)] hover:bg-kick-green/90 hover:shadow-[0_12px_34px_rgba(34,197,94,0.30)]'
                                            }`}
                                        >
                                            {claimingId === achievement.id ? (
                                                <>
