...
export default function PointsBar({ points, className, showLearnButton = true }: PointsBarProps) {
    ...
    return (
        <>
            ...
            <HowToEarnPointsModal isOpen={isHowToOpen} onClose={() => setIsHowToOpen(false)} />
        </>
    )
}
