...
export default function AdminAIModeratorPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900 dark:text-kick-text">AI moderator</h1>
        <p className="text-sm text-gray-600 dark:text-kick-text-secondary">
          Admin-only controls for Sweetflipsbot (AI moderation, replies, and slot calls).
        </p>
      </div>
