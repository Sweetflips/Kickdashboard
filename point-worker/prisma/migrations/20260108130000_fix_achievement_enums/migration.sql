-- Fix Achievement Enums
-- This migration ensures the achievement enums exist with correct values

-- Drop and recreate enums to ensure correct state
-- First, drop dependent constraints/columns temporarily if needed
...
-- Recreate the tables with the correct enum types (in case they were dropped by CASCADE)
