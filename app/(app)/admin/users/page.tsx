                          ...
                          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div>
                              ...
                              <div className="mt-4">
                                ...
                                {/* Clean Permission Controls */}
                                <div className="rounded-xl border border-gray-200 dark:border-kick-border bg-white/70 dark:bg-kick-surface/40 overflow-hidden">
                                  <div className="divide-y divide-gray-200 dark:divide-kick-border">
                                    {/* Admin */}
                                    <div className="flex items-start gap-3 px-4 py-3">
                                      <input
                                        ...
                                        className="mt-1 h-4 w-4 rounded border-gray-300 dark:border-kick-border text-kick-purple focus:ring-kick-purple"
                                      />
                                      <div className="flex-1 min-w-0">
                                        <div className="flex items-center justify-between gap-3">
                                          <div className="font-medium text-gray-900 dark:text-kick-text">Admin</div>
                                          <span className={`text-xs px-2 py-0.5 rounded-full border ${
                                            user.is_admin
                                              ? 'bg-kick-purple/15 text-kick-purple border-kick-purple/30'
                                              : 'bg-gray-100 dark:bg-kick-dark text-gray-600 dark:text-kick-text-secondary border-gray-200 dark:border-kick-border'
                                          }`}>
                                            {user.is_admin ? 'Enabled' : 'Off'}
                                          </span>
                                        </div>
                                    ...
                                    <div className="flex items-start gap-3 px-4 py-3">
                                      <input
                                        type="checkbox"
                                        checked={user.moderator_override === true}
                                        onClick={(e) => e.stopPropagation()}
                                        onChange={(e) => {
                                          e.stopPropagation()
                                          setModeratorOverride(user.kick_user_id, e.target.checked)
                                        }}
                                        className="mt-1 h-4 w-4 rounded border-gray-300 dark:border-kick-border text-kick-purple focus:ring-kick-purple"
                                      />
                                      <div className="flex-1 min-w-0">
                                        <div className="flex items-center justify-between gap-3">
                                          <div className="font-medium text-gray-900 dark:text-kick-text">Moderator</div>
                                          <span className={`text-xs px-2 py-0.5 rounded-full border ${
                                            user.moderator_override === true
                                              ? 'bg-blue-500/15 text-blue-700 dark:text-blue-300 border-blue-500/30'
                                              : 'bg-gray-100 dark:bg-kick-dark text-gray-600 dark:text-kick-text-secondary border-gray-200 dark:border-kick-border'
                                          }`}>
                                            {user.moderator_override === true ? 'Enabled' : 'Off'}
                                          </span>
                                        </div>
                                        <div className="text-xs text-gray-600 dark:text-kick-text-secondary">
                                          Can view payouts and has elevated permissions.
                                        </div>
                                      </div>
                                    </div>
                                    ...
                                    <div className="flex items-start gap-3 px-4 py-3">
                                      ...
                                      <div className="flex-1 min-w-0">
                                        <div className="flex items-center justify-between gap-3">
                                          <div className="font-medium text-gray-900 dark:text-kick-text">Exclude user</div>
                                          <span className={`text-xs px-2 py-0.5 rounded-full border ${
                                            user.is_excluded
                                              ? 'bg-orange-500/15 text-orange-700 dark:text-orange-300 border-orange-500/30'
                                              : 'bg-gray-100 dark:bg-kick-dark text-gray-600 dark:text-kick-text-secondary border-gray-200 dark:border-kick-border'
                                          }`}>
                                            {user.is_excluded ? 'Enabled' : 'Off'}
                                          </span>
                                        </div>
                                        <div className="text-xs text-gray-600 dark:text-kick-text-secondary">
                                          Prevents raffles/points and restricts certain features.
                                        </div>
                                      </div>
                                    </div>
                                    ...
                                    {/* Adjust SweetCoins */}
                                    <div className="flex items-start gap-3 px-4 py-3">
                                      <div className="mt-1 h-4 w-4 rounded border border-gray-200 dark:border-kick-border bg-gray-50 dark:bg-kick-dark flex items-center justify-center text-[10px] text-gray-500 dark:text-kick-text-secondary">
                                        💰
                                      </div>
                                      <div className="flex-1 min-w-0">
                                        <div className="flex items-center justify-between gap-3">
                                          <div className="font-medium text-gray-900 dark:text-kick-text">Adjust SweetCoins</div>
                                          <button
                                            type="button"
                                            onClick={(e) => {
                                              e.stopPropagation()
                                            ...
                                            className="px-3 py-1.5 rounded-lg text-xs font-medium border border-gray-200 dark:border-kick-border bg-white dark:bg-kick-surface hover:bg-gray-50 dark:hover:bg-kick-surface-hover text-gray-900 dark:text-kick-text transition-colors"
                                          >
                                            Open
                                          </button>
                                        </div>
                                        <div className="text-xs text-gray-600 dark:text-kick-text-secondary">
                                          Award or deduct SweetCoins with an optional reason (logged).
                                        </div>
                                      </div>
                                    </div>
                                  </div>
